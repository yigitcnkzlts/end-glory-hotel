  ...
  useEffect(() => {
    ...
    setRooms([
      ...
      },
      {
        ...
        description: 'Ultimate luxury with separate living area and jacuzzi',
        capacity: 4,
        price: 2500,
        images: ['https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=2070'],
        amenities: ['King Bed', 'Jacuzzi', 'Living Room', 'Butler Service'],
        size: 80,
        bedType: 'King + Sofa',
        available: true,
      },
      {
        ...
        amenities: ['Queen Bed', 'Work Desk', 'Smart TV', 'WiFi'],
        size: 35,
        bedType: 'Queen',
        available: true,
      },
  ...
  return (
    <section className="bg-gray-50 py-20">
      <div className="container-custom">
        ...
        >
          <h2 className="mb-4 font-serif text-4xl font-bold md:text-5xl">{t('featuredRooms')}</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            Experience unparalleled luxury in our carefully designed rooms and suites
          </p>
        </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  <div className="mb-2 flex items-start justify-between">
                    <h3 className="font-serif text-2xl font-semibold group-hover:text-primary-600">
                      {room.name}
                    </h3>
        ...
        >
          <Link
            href="/rooms"
            className="inline-block rounded-lg border-2 border-primary-600 px-8 py-3 font-semibold text-primary-600 transition-all hover:bg-primary-600 hover:text-white"
          >
            View All Rooms
          </Link>
        </motion.div>
